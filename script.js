...
// this will add this function to all the elements. But if we have 100s of element it will slow down the page.
...
const handleHover=function(e,x){
...
const sectionObsrver=new IntersectionObserver(revealSection,{
  root:null,
  threshold:0.15
})

sections.forEach(function(section){
  sectionObsrver.observe(section);
...
const imageLoad=function(enteries,observer){
  const [entry]=enteries;
  if(!entry.isIntersecting) return;
